...
public class GcmSender {
    ...
    public static final String API_KEY = "AIzaSyBQk3b6IDYdWQzvMUuBWA_zQbPi5KD7gRI";
    public static void main(String[] args) {
        ...
        try {
            String mess = Reply.MessageButton;
            // Prepare JSON containing the GCM message content. What to send and where to send.
            JSONObject jGcmData = new JSONObject();
            JSONObject jData = new JSONObject();

                jData.put("fromAddr",args[0].trim());//ajay
                jData.put("toAddr", args[1].trim());//sarathy
                jData.put("Date",args[2].trim());//date
                jData.put("Time",args[3].trim());//time
            jData.put("meet",args[4].trim());
